...
const PersonalBests = ({ time, words }: PersonalBestsProps) => {
   return (
      <div className="personalBests grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-4 md:gap-8">
         <div className="pbsTime grid grid-cols-3 items-center justify-center gap-4 p-4 bg-alt-bg rounded-lg">
         ...
         <div className="pbsWord grid grid-cols-3 items-center justify-center gap-4 p-4 bg-alt-bg rounded-lg">
